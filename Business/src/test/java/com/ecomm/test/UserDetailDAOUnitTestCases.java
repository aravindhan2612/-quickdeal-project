...
public class UserDetailDAOUnitTestCases {
	...
	public void registerUserTest()
	{
		...
		user.setPassword("aravind123");
		user.setUsername("aravind123");
	...
	{
		UserDetail user=userDetailDAO.getUser("priya29");
		assertTrue("Problem in user Deletion:",userDetailDAO.deleteUser(user));
	}
